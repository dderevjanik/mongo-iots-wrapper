...
export const createDocument = <DOCUMENT_VAL extends ExtendableObject>(database: Db, documentName: string, validator: ExtendableObject): Document<t.TypeOf<DOCUMENT_VAL>> => {
